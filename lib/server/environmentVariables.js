Kadira._parseEnv = (env) => {
  const options = {};

  for (const name of Object.keys(env)) {
    const info = Kadira._parseEnv._options[name];
...
Kadira._parseEnv.parseBool = (val) => {
...
Kadira._parseEnv.parseUrl = (str) => str;

Kadira._parseEnv.parseString = (str) => str;
