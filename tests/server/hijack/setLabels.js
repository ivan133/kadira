...
Tinytest.add(
  ...
  function (test) {
    const name = MeteorX.Multiplexer.prototype._sendAdds.name;
...
Tinytest.add(
  ...
  function (test) {
    const cursorProto = MeteorX.MongoConnection.prototype;
...
Tinytest.add(
  ...
  function (test) {
    const crossbarProto = DDPServer._Crossbar.prototype;
